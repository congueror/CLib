...
import com.congueror.clib.datagen.ModTags.Items.Blocks;
...
public class ModTags 
{
	...
	public static class Items {
		...
		public static final IOptionalNamedTag<Item> DUSTS = tag("dusts");
			...
			public static final IOptionalNamedTag<Item> PYROTHEUM = tag("dusts/pyrotheum");
			public static final IOptionalNamedTag<Item> SULFUR = tag("dusts/sulfur");
		public static final IOptionalNamedTag<Item> GEMS = tag("gems");
			public static final IOptionalNamedTag<Item> AMETHYST = tag("gems/amethyst");
			public static final IOptionalNamedTag<Item> OPAL = tag("gems/opal");
			public static final IOptionalNamedTag<Item> RUBY = tag("gems/ruby");
			public static final IOptionalNamedTag<Item> SAPPHIRE = tag("gems/sapphire");
		public static final IOptionalNamedTag<Item> INGOTS = tag("ingots");
			public static final IOptionalNamedTag<Item> ALUMINUM = tag("ingots/aluminum");
			public static final IOptionalNamedTag<Item> BRONZE = tag("ingots/bronze");
			public static final IOptionalNamedTag<Item> COPPER = tag("ingots/copper");
			public static final IOptionalNamedTag<Item> ELECTRUM = tag("ingots/electrum");
			public static final IOptionalNamedTag<Item> ENDERIUM = tag("ingots/enderium");
			public static final IOptionalNamedTag<Item> INVAR = tag("ingots/invar");
			public static final IOptionalNamedTag<Item> LEAD = tag("ingots/lead");
			public static final IOptionalNamedTag<Item> LUMIUM = tag("ingots/lumium");
			public static final IOptionalNamedTag<Item> NICKEL = tag("ingots/nickel");
			public static final IOptionalNamedTag<Item> PLATINUM = tag("ingots/platinum");
			public static final IOptionalNamedTag<Item> SIGNALUM = tag("ingots/signalum");
			public static final IOptionalNamedTag<Item> SILVER = tag("ingots/silver");
			public static final IOptionalNamedTag<Item> STEEL = tag("ingots/steel");
			public static final IOptionalNamedTag<Item> TIN = tag("ingots/tin");
			public static final IOptionalNamedTag<Item> TITANIUM = tag("ingots/titanium");
			public static final IOptionalNamedTag<Item> TUNGSTEN = tag("ingots/tungsten");
